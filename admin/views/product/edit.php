            ...
            <main class="col-md-10 ms-sm-auto px-md-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="index.php?act=product-edit&id=<?php echo $product['id']; ?>" enctype="multipart/form-data">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="price" name="price" value="<?php echo $product['price']; ?>" required min="0">
                            </div>

                            <div class="mb-3">
                                <label for="discount_price" class="form-label">Giá khuyến mãi</label>
                                <input type="number" class="form-control" id="discount_price" name="discount_price" value="<?php echo $product['discount_price']; ?>" min="0">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <?php if ($product['image']): ?>
                                    <div class="mb-2">
                                        <img src="<?php echo BASE_URL . $product['image']; ?>" alt="<?php echo $product['name']; ?>" style="max-width: 200px;">
                                    </div>
                                <?php endif; ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="import_date" name="import_date" value="<?php echo $product['import_date']; ?>" required>
                            </div>
